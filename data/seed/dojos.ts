/**
 * Seed: Dojos — all dojo/branch location records (single source of truth).
 */
...
export const allDojos: DojoRecord[] = [
  {
    id: 'koramangala',
    slug: 'koramangala',
...
export function getDojoBySlug(slug: string) {
  return allDojos.find(d => d.slug === slug) ?? null
}

export function getHQDojo() {
  return allDojos.find(d => d.id === 'koramangala') ?? allDojos[0]
}

/** Alias for backward compatibility */
export const dojos = allDojos
