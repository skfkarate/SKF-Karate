...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_PAYMENT_ACCOUNT_HOLDER: optionalString(z.string().min(1)),
  NEXT_PUBLIC_PAYMENT_PHONE: optionalString(z.string().min(1)),
  NEXT_PUBLIC_PAYMENT_UPI_ID: optionalString(z.string().min(1)),
  ...
  FEETRACK_WEB_PUSH_PUBLIC_KEY: optionalString(z.string().min(1)),
  FEETRACK_WEB_PUSH_PRIVATE_KEY: optionalString(z.string().min(1)),
  FEETRACK_WEB_PUSH_SUBJECT: optionalString(z.string().min(1)),
