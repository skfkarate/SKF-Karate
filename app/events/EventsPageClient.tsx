...
import { FaCalendarAlt, FaMapMarkerAlt, FaUsers, FaArrowRight, FaFilter } from 'react-icons/fa'
...
export default function EventsPageClient({ upcomingEvents }: any) {
