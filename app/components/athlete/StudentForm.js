            ...
            <div className="space-y-5 bg-[rgba(0,0,0,0.3)] p-6 rounded-xl border border-[rgba(255,255,255,0.05)]">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <input required name="firstName" value={formData.firstName} onChange={handleInfoChange} type="text" className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red focus:ring-1 focus:ring-brand-red outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Last Name *</label>
                  <input required name="lastName" value={formData.lastName} onChange={handleInfoChange} type="text" className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red focus:ring-1 focus:ring-brand-red outline-none transition-all" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-5">
                <div>
                  <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Date of Birth *</label>
                  <input required name="dateOfBirth" value={formData.dateOfBirth} onChange={handleInfoChange} type="date" className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red focus:ring-1 focus:ring-brand-red outline-none transition-all [color-scheme:dark]" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Gender *</label>
                  <select required name="gender" value={formData.gender} onChange={handleInfoChange} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red focus:ring-1 focus:ring-brand-red outline-none transition-all appearance-none cursor-pointer">
              ...
              <div>
                ...
                <input name="photoUrl" value={formData.photoUrl} onChange={handleInfoChange} type="text" placeholder="https://..." className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red focus:ring-1 focus:ring-brand-red outline-none transition-all placeholder:text-gray-600" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <input name="parentName" value={formData.parentName} onChange={handleInfoChange} type="text" className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red focus:ring-1 focus:ring-brand-red outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Phone</label>
                  <input name="phone" value={formData.phone} onChange={handleInfoChange} type="tel" className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red focus:ring-1 focus:ring-brand-red outline-none transition-all" />
                </div>
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Email</label>
                <input name="email" value={formData.email} onChange={handleInfoChange} type="email" className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red focus:ring-1 focus:ring-brand-red outline-none transition-all" />
              </div>
            </div>
            ...
            <div className="space-y-5 bg-[rgba(0,0,0,0.3)] p-6 rounded-xl border border-[rgba(255,255,255,0.05)]">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <select required name="branchName" value={formData.branchName} onChange={handleInfoChange} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-gold focus:ring-1 focus:ring-gold outline-none transition-all appearance-none cursor-pointer">
                    {['Sunkadakatte', 'Rajajinagar', 'Malleshwaram', 'Yeshwanthpur', 'Vijayanagar'].map(b => <option key={b} value={b}>{b}</option>)}
                  </select>
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Status *</label>
                  <select required name="status" value={formData.status} onChange={handleInfoChange} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-gold focus:ring-1 focus:ring-gold outline-none transition-all appearance-none cursor-pointer">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <select required name="currentBelt" value={formData.currentBelt} onChange={handleInfoChange} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-gold focus:ring-1 focus:ring-gold outline-none transition-all appearance-none cursor-pointer">
                    {BELTS.map(b => (
                ...
                <div>
                  ...
                  <input required name="joinDate" value={formData.joinDate} onChange={handleInfoChange} type="date" className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-gold focus:ring-1 focus:ring-gold outline-none transition-all [color-scheme:dark]" />
                </div>
              </div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red outline-none appearance-none font-medium"
                  >
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="text" value={newAchievement.title} onChange={e => setNewAchievement({ ...newAchievement, title: e.target.value })} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red outline-none" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Date *</label>
                    <input type="date" value={newAchievement.date} onChange={e => setNewAchievement({ ...newAchievement, date: e.target.value })} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red outline-none [color-scheme:dark]" />
                  </div>
                </div>
                ...
                {newAchievement.type === 'belt-grading' && (
                  <div>
                    ...
                    <select value={newAchievement.beltEarned} onChange={e => setNewAchievement({ ...newAchievement, beltEarned: e.target.value })} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red outline-none appearance-none">
                ...
                {newAchievement.type.startsWith('tournament') && (
                  <div className="grid grid-cols-2 gap-5">
                    <div>
                      ...
                      <select value={newAchievement.tournamentLevel} onChange={e => setNewAchievement({ ...newAchievement, tournamentLevel: e.target.value })} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red outline-none appearance-none">
                    ...
                    <div>
                      ...
                      <input type="number" value={newAchievement.pointsAwarded} onChange={e => setNewAchievement({ ...newAchievement, pointsAwarded: e.target.value })} className="w-full bg-[rgba(20,33,61,0.5)] text-white border border-[rgba(255,255,255,0.1)] rounded p-3 focus:border-brand-red outline-none font-mono" />
                    </div>
                  </div>
                )}
              </div>
