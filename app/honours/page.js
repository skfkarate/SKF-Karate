        ...
        <div className="honours-page">
            <section className="page-hero">
                ...
                <div className="container page-hero__content">
                    <span className="section-label"><FaTrophy /> Honours</span>
                    <h1 className="page-hero__title">Honours <span className="text-gradient">Board</span></h1>
            ...
            <section className="section milestones-section">
                <div className="container">
                    <div className="milestones__grid">
                        {milestones.map((m, i) => (
                            <div className="glass-card milestone-card" key={i}>
            ...
            <section className="section">
                <div className="glow glow-gold champions__glow"></div>
                <div className="container">
                    <div className="champions__header">
                        <span className="section-label"><FaMedal /> Champions</span>
                        <h2 className="section-title">Our <span className="text-gradient">Champions</span></h2>
                        <p className="section-subtitle" style={{ margin: '0 auto' }}>State, National, and International achievers who carry the SKF banner with pride.</p>
                    </div>
                    <div className="champions__grid">
                        {champions.map((c, i) => (
                            <div className="glass-card champion-card" key={i}>
                                <div className={`champion-card__badge champion-card__badge--${c.cat}`}>{c.cat}</div>
                                <h3>{c.name}</h3>
                                <p>{c.achievement}</p>
                                <span className="champion-card__year">{c.year}</span>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="section awards-section">
                <div className="container">
                    <div className="awards__header">
                        <span className="section-label"><FaAward /> Annual Awards</span>
                        <h2 className="section-title">Year-End <span className="text-gradient">Awards 2025</span></h2>
                    </div>
                    <div className="awards__grid">
                        {awards.map((a, i) => (
                            <div className="glass-card award-card" key={i}>
                                ...
                                <h4>{a.title}</h4>
                                <p className="award-card__recipient">{a.recipient}</p>
