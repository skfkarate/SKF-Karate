...
WITH legacy_billing(skf_id, billing_status, monthly_fee, branch_snapshot) AS (
  ...
  ('SKF25MP001', 'active', 2500, 'M P Sports Club'),
...
WITH legacy_fee_rows(skf_id, fee_type, month, year, amount, status, source_status, source_sheet) AS (
  ...
  ('SKF25MP001', 'monthly', 'January', 2026, 2500, 'paid', 'Paid', 'Fees_MP'),
  ('SKF25MP001', 'monthly', 'February', 2026, 2500, 'paid', 'Paid', 'Fees_MP'),
  ('SKF25MP001', 'monthly', 'March', 2026, 2500, 'paid', 'Paid', 'Fees_MP'),
  ('SKF25MP001', 'monthly', 'April', 2026, 2500, 'break', 'Break', 'Fees_MP'),
  ('SKF25MP001', 'monthly', 'May', 2026, 2500, 'due', 'Pending', 'Fees_MP'),
