...
let tournaments: TournamentRecord[] = [
  {
    id: 't-new-1',
    slug: 'kio-national-championship-2024',
    name: 'KIO All India Karate Championship 2024',
    shortName: 'KIO National 2024',
    level: 'national',
    date: '2024-02-15',
    endDate: '2024-02-18',
    ...
    city: 'New Delhi',
    state: 'Delhi',
    description: 'The official national championship sanctioned by Karate India Organisation (KIO). The largest karate event of the year featuring competitors from 28 states.',
    totalParticipants: 1200,
    skfParticipants: 45,
    medals: { gold: 12, silver: 8, bronze: 15 },
    affiliatedBody: 'KIO',
    status: 'completed',
    isPublished: true,
    isFeatured: true,
    ...
    winners: [
      ...
      { id: 'w-kio2', athleteName: 'Anjali Sharma', belt: 'Black Belt 1st Dan', branchName: 'Malleshwaram', category: 'kata-individual', ageGroup: 'senior', medal: 'silver', position: 2 },
      { id: 'w-kio3', athleteName: 'Rohan Patil', belt: 'Brown Belt', branchName: 'Yeshwanthpur', category: 'kumite-individual', ageGroup: 'junior', weightCategory: 'Under 60kg', medal: 'bronze', position: 3 },
      { id: 'w-kio4', athleteName: 'Pooja Hegde', belt: 'Black Belt 1st Dan', branchName: 'Sunkadakatte', category: 'kumite-individual', ageGroup: 'senior', weightCategory: 'Under 55kg', medal: 'gold', position: 1 },
      { id: 'w-kio5', athleteName: 'Tarun Reddy', belt: 'Blue Belt', branchName: 'Vijayanagar', category: 'kata-individual', ageGroup: 'sub-junior', medal: 'silver', position: 2 },
      { id: 'w-kio6', athleteName: 'Sunil Shetty', belt: 'Brown Belt', branchName: 'Sunkadakatte', category: 'kumite-team', ageGroup: 'senior', medal: 'gold', position: 1 },
    ],
  },
  {
    id: 't1',
