...
/** @type {readonly ['draft', 'upcoming', 'ongoing', 'completed', 'archived']} */
export const TOURNAMENT_STATUSES = ['draft', 'upcoming', 'ongoing', 'completed', 'archived']
 ...
 * @property {'draft'|'upcoming'|'ongoing'|'completed'|'archived'} [status]
