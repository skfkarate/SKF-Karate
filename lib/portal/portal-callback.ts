...
export function buildPortalLoginUrl(callbackUrl: unknown): string {
  return `/portal/login?callbackUrl=${encodeURIComponent(sanitizePortalCallbackUrl(callbackUrl))}`
}
